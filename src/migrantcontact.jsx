...
export default function MigrantContact() {
  ...
  const whatsappMessage = encodeURIComponent(
    firstName ? `Hola, soy ${firstName}. Tengo una consulta sobre SaludCompartida` : `Hola, tengo una consulta sobre SaludCompartida`
  );
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full py-6 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold text-xl rounded-xl transition-all shadow-xl hover:shadow-2xl transform hover:scale-[1.02]"
          >
