            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Formato: +1 seguido de 10 dígitos</p>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Estado en EE.UU.</label>
                  <select
                    name="estado"
                    required
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">¿Dónde vive tu familia?</label>
                  <select
                    name="paisFamilia"
                    required
                    ...
                    {familiares.map((familiar, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-xl border border-gray-200 space-y-3">
                        ...
                        <div>
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">Formato: +52 seguido de 10 dígitos</p>
                        </div>
