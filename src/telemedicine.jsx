        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-3xl shadow-2xl p-12 text-center">
          ...
          <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto">
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 bg-white text-green-600 px-6 py-3 rounded-xl font-bold text-lg hover:bg-green-50 transition-all"
            >
          ...
          <div className="mt-8 bg-cyan-500/20 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto border-2 border-cyan-300">
            <div className="flex items-start gap-4">
              <div className="bg-cyan-400 rounded-full p-2 flex-shrink-0">
              ...
              <div className="text-left">
                <p className="text-white font-bold text-lg mb-2">
                  💊 ¿El doctor te prescribió medicamentos?
                </p>
                <p className="text-white/90 mb-3">
                  Obtén hasta <span className="font-bold text-cyan-200">75% de descuento</span> en tu receta médica
                </p>
                <button
                  onClick={() => {
                    window.scrollTo(0, 0);
                  ...
                  className="bg-white text-cyan-600 px-6 py-3 rounded-xl font-bold hover:bg-cyan-50 transition-all inline-flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                  Ir a Farmacias con Descuento
                </button>
              </div>
            </div>
          </div>
